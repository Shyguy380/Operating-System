...
int findSubString( const char *testStr, const char *searchSubStr)
    ...
    // assume test failed at this point, return SUBSTRING_NOT_FOUND
...
bool getStringConstrained( 
    ...
    while(
        ...
        // AND
        // continues if specified delimiter not set
        ...
        // initialize captured string back
        capturedString[ index ] = NULL_CHAR;
...
Process: captures a string from the input stream to a specified delimiter; 
         Note: consumes delimiter
Function Input/Parameters: input stream (FILE *)
                           stops at specified delimiter (char)
Function Output/Parameters: string returned (char *)
...
void getSubString( char *destStr, const char *sourceStr, 
    ...
    // initialize function/variables
        ...
        // intialize the destination index to 0
        int destIndex = 0;
    ...
    if( startIndex >= 0 && startIndex <= endIndex 
        ...
        {
        // create temporary string (aliasing)
            // function: malloc, copyString
...
void setStrToLowerCase( char *destStr, const char *sourceStr)
    ...
    // release memory used for temp strin
        // function: free
    free( tempStr );
    }
